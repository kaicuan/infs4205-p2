...
import TabBInput from "@/components/tab-b-input";

export default function TabBContent({ locations } : { locations : Location[] }) {

  return (
    <div className="max-w-2xl mx-auto space-y-4">
      <p className="text-sm text-gray-500 dark:text-gray-400 italic px-2 text-justify">
      Finds the nearest popular spots to the center point, requiring at least N check-ins. 
      Results can be filtered by date range and limited to check-ins from friends only.
      </p>
